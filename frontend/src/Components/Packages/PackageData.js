...
export const packagesTravlling = [
    {
      ...
      itinerary: [
        ...
        {
          day: 'Day 2: Scenic Coastal Drive',
          details: [
            'Depart for a breathtaking coastal drive.',
            'Stop at [Scenic Point 1] for photos.',
            'Lunch in a coastal village.',
            'Continue to [Scenic Point 2] for panoramic views.',
            'Arrive at a seaside resort for dinner and overnight stay.',
          ],
        },
        {
          day: 'Day 3: Coastal National Park Exploration',
         details: [
          'Explore [National Park] with guided nature walks.',
          'Picnic lunch amidst nature.',
          'Afternoon optional activities (kayaking, bird watching).',
          'Return to the resort for a relaxing evening',
          ],
        },
   {
          day: 'Day 4:  Quaint Coastal Town Visit',
          details: [
          'Visit the charming town of [Town].',
          'Guided walking tour of historic sites and local markets.',
          'Lunch at a seaside cafe.',
          'Leisure time for shopping and exploring.',
          'Return to the resort for dinner.', 
],
        },
   {
          day: 'Day 5:Coastal Cuisine and Cultural Experience',
          details: [
            'Cooking class featuring local coastal cuisine.',
          'Enjoy the fruits of your labor for lunch.',
          'Afternoon cultural performance.',
          'Evening beach bonfire and seafood barbecue.',
        ],
        },
   {
          day: 'Day 6:  Coastal Adventure Activities',
          details: [
          'Exciting coastal adventure activities (choose from options:surfing, sailing, or hiking).',
          'Lunch at an adventure hub.',
          'Free time to explore the surroundings.',
          'Farewell dinner with a view of the sunset.',
          ],
        },
        {
          day: 'Day 7: Departure',
          details: [
            ...
            'Transfer to the city for departure.',
          ],
        },
      ],
      packageInclusions: [
        ...
        'Transportation via comfortable air-conditioned bus.',
